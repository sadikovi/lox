...
int disassembleInstruction(Chunk* chunk, int offset) {
  ...
  switch (instruction) {
    ...
    case OP_DEFINE_GLOBAL:
      return constantInstruction("OP_DEFINE_GLOBAL", instruction, chunk, offset);
    case OP_GET_GLOBAL:
      return constantInstruction("OP_GET_GLOBAL", instruction, chunk, offset);
    case OP_SET_GLOBAL:
      return constantInstruction("OP_SET_GLOBAL", instruction, chunk, offset);
    case OP_GET_LOCAL:
    ...
    case OP_GET_SUPER:
      return constantInstruction("OP_GET_SUPER", instruction, chunk, offset);
    case OP_POP:
    ...
    case OP_CLASS:
      return constantInstruction("OP_CLASS", instruction, chunk, offset);
    case OP_INHERIT:
      return simpleInstruction("OP_INHERIT", offset);
    case OP_METHOD:
      return constantInstruction("OP_METHOD", instruction, chunk, offset);
    default:
